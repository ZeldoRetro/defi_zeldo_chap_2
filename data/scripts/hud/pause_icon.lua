...
function pause_icon_builder:new(game)
  ...
  function pause_icon:initialize()
  ...
  function pause_icon:rebuild_surface()
    ...
    if pause_icon.icon_region_y ~= nil then
      ...
      pause_icon.icons_img:draw_region(0, pause_icon.icon_region_y, 72, 24, pause_icon.surface)
    else
      -- Draw the flipping sprite
      pause_icon.icon_flip_sprite:draw(pause_icon.surface, 24, 0)
    end
  end

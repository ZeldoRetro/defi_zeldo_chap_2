...
function gui_designer:create(width, height)
  ...
  function widget:make_blue_frame(x, y, width, height)
    draw_frame_8_8(72, 24, canvas, x, y, width, height)
  end
  ...
  function widget:make_counter(text, x, y, alignment)
    alignment = alignment or "left"
    local text_surface = sol.text_surface.create{
      text = text,
      font = "white_digits",
  ...
  function widget:make_green_counter(text, x, y, alignment)
    alignment = alignment or "left"
    local text_surface = sol.text_surface.create{
      text = text,
      font = "green_digits",
